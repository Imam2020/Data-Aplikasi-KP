...
if(isset($_POST['tambah'])){
    mysqli_query($conn,"INSERT INTO tb_login set
    nama = '$_POST[nama]',
    email = '$_POST[email]',
                                            ...
                                            <div class="form-row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="nama" type="text" placeholder="Masukan Nama Pengguna" required />
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1">Email</label>
                                                        <input class="form-control" name="email" type="text" placeholder="Masukkan Email Pengguna" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <hr height="2">
