                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark bg-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="Data_Ruangan.php" style="background-color: #009966; color: white;" data-toggle="collapse" data-target="#collapseReport" aria-expanded="false" aria-controls="collapseReport">
...
<?php 
    $id =$_GET['id'];
    $query_mysqlis = mysqli_query($conn,"SELECT * FROM tb_ruangan where id='$id'")or die(mysqli_error());
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="id_ruangan" type="text" value="<?php echo $mfa['id_ruangan'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="nama_ruangan" type="text" value="<?php echo $mfa['nama_ruangan'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="lantai" type="number" value="<?php echo $mfa['lantai'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group">
                                                            ...
                                                            <!-- <select class="form-control" name="keterangan">
                                                                <option value="Indoor">Indoor</option>
                                                                <option value="Outdoor">Outdoor</option>
                                                                <option value="Dipakai" selected>Dipakai</option>
                                                            </select> -->
                                                        </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group">
                                                            ...
                                                            <input class="form-control" name="kapasitas" type="number" value="<?php echo $mfa['kapasitas'] ?>">
                                                        </div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group">
                                                            ...
                                                            <input class="form-control" name="jenis" type="text" value="<?php echo $mfa['jenis'] ?>">
                                                        </div>
                                                </div>
                                            </div>
