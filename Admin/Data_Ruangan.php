...
<html lang="en">
    ...
    <body class="sb-nav-fixed" style="background: #ecf0f1">
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background: #009966">
            &nbsp <h2 style="color: white;"><STRONG>SMPN X</STRONG></h2>
                ...
                <main>
                    <div class="container-fluid">
                       ...
                       <div class="table-responsive">
                        <a href="Tambah_ruangan.php" type="submit" class="btn btn-outline-success mb-1"><i class="fas fa-plus"></i>Tambah Data Ruangan</a>
                    ...
                    ?>
                                            <tr align="center">
                                                ...
                                                <td width="30">
                                                    <a class="edit" href="ubah_ruangan.php?id=<?php echo $data['id']; ?>">
                                                        <div class="sb-nav-link-icon btn btn-outline-primary"><i class="fas fa-edit"></i>Edit</div>
                                                    </a></td>
                                                <td width="30">
                                                    <a onclick="return confirm('Yakin Ingin Menghapus Ruangan Ini?...')" class="hapus" href="hapus_ruangan.php?id=<?php echo $data['id']; ?>">
